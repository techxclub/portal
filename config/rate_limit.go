...
type RateLimit struct {
	...
	AdminFetchCompanyLogo  RateLimitConfig `yaml:"ADMIN_FETCH_COMPANY_LOGO" env:",prefix=ADMIN_FETCH_COMPANY_LOGO_"`
	AdminUploadCompanyLogo RateLimitConfig `yaml:"ADMIN_UPLOAD_COMPANY_LOGO" env:",prefix=ADMIN_UPLOAD_COMPANY_LOGO_"`
...
func defaultRateLimit() RateLimit {
	return RateLimit{
		...
		AdminFetchCompanyLogo:  RateLimitConfig{Enabled: true, Attempts: 100, WindowSecs: 600},
		AdminUploadCompanyLogo: RateLimitConfig{Enabled: true, Attempts: 100, WindowSecs: 600},
...
func (rl RateLimit) GetAPIRateLimitConfig(apiName string) RateLimitConfig {
	...
	case constants.APINameAdminFetchCompanyLogo:
		return rl.AdminFetchCompanyLogo
	case constants.APINameAdminUploadCompanyLogo:
		return rl.AdminUploadCompanyLogo
